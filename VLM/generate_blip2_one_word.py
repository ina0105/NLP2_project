...
OUTPUT_DIR = "/home/scur2169/NLP2_project/vlm_one_word_representations"
...
for word in words:
    ...
    try:
        # Provide the word itself as the sentence context
        reps = extract_representations_from_sentences(word, image_paths, [word], format_sentences=False)
